    ...
    <div class="flex h-screen">
        ...
        <div class="bg-white-800 text-gray-600 w-64 space-y-3 py-2 px-2 fixed h-full border">
            ...
            <div class="text-black flex ">
                <img src="{{asset('assets/images/image.png')}}" class="w-36 h-14" alt="">
            </div>
            ...
            <nav>
                ...
                class="flex items-center py-2.5 px-4 rounded transition duration-200 hover:bg-blue-700 hover:text-white 
                    ...
                    <svg class="h-6 w-6 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                ...
                {{ request()->routeIs('users.index') ? 'bg-blue-700 text-white' : '' }}">
                <svg class="h-6 w-6 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                    <path strokeLinecapP="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" />
                </svg>
            ...
            <div class="py-1">
                    ...
                    {{ request()->routeIs('books.index') ? 'bg-blue-700 text-white' : '' }}">
                        <svg class="h-6 w-6 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                ...
                {{ request()->routeIs('categories.index') ? 'bg-blue-700 text-white' : '' }}">
                    <svg class="h-6 w-6 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                ...
                <div class="py-1">
                                    ...
                                    {{ request()->routeIs('loans.index') ? 'bg-blue-700 text-white' : '' }}">
                                        <svg class="h-6 w-6 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                ...
                <div class="py-1">
                    ...
                    {{ request()->routeIs('articles.index') ? 'bg-blue-700 text-white' : '' }}">
                        <svg class="h-6 w-6 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
        ...
        <div class="flex-1 ml-64 rounded-lg">
            <div class="sticky top-0 bg-white flex justify-end items-center space-x-4 p-4 border z-10">
