        ...
        <table class="min-w-full bg-white">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="py-2 px-4 border-b text-center"><img src="{{ asset('storage/articles/images/' . $article->article_image) }}" alt="Article Image" class="w-16 h-16"></td>
                    <td class="py-2 px-4 border-b text-center">
                        ...
                        <a href="{{ route('articles.show', $article->article_id) }}" class="bg-blue-500 text-white px-2 py-1 rounded hover:bg-blue-700" style="width: 60px; display: inline-block; text-align: center;">Detail</a>
