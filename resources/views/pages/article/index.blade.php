...
<div class="bg-blue-50 rounded-lg">
    <div class="p-5">
        <h1 class="text-2xl font-medium mb-5">Articles</h1>
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="{{ route('articles.index') }}" class="ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2">Articles</a>
                </div>
            </li>
        </ol>
    </nav>
