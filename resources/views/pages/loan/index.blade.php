                        ...
                        loansTableBody.innerHTML += `
                            <tr>
                                ...
                                <td class="py-2 px-4 border-b text-center flex items-center justify-center">
                                    ${loan.loan_status === 'returned' ? '<div class="h-2.5 w-2.5 rounded-full bg-green-500 mr-2"></div>' : ''}
                                    ${loan.loan_status === 'overdue' ? '<div class="h-2.5 w-2.5 rounded-full bg-red-500 mr-2"></div>' : ''}
                                    ${loan.loan_status === 'borrowed' ? '<div class="h-2.5 w-2.5 rounded-full bg-yellow-500 mr-2"></div>' : ''}
                                    ${loan.loan_status }
                                </td>
